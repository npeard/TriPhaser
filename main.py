...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 1:
        # Whether or not a directory is given as a command-line argument determines whether we are in simulation mode or data process mode
        ...
        #plot = Plot_2D.Plot_2D(num_pix=11, num_atoms=3, kmax=7, useCrystal = False, useDFT=False)
